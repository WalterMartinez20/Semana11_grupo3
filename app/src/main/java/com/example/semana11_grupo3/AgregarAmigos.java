package com.example.semana11_grupo3;
...
public class AgregarAmigos extends AppCompatActivity {
    ...
    private void tomarFotoAmigo(){
        ...
        if( tomarFotoIntent.resolveActivity(getPackageManager())!=null ){
            ...
            if( photoAmigo!=null ){
                try{
                    Uri uriPhotoAmigo = FileProvider.getUriForFile(AgregarAmigos.this, "com.example.semana11_grupo3.fileprovider",photoAmigo);
